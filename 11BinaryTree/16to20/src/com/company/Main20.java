...
public class Main20 {
    ...
    private static int track = 0;//keeps track of preOrder index i.e. next root element to be made
    private static HashMap<Integer, Integer> map = new HashMap<>();//map for inOrderIndex arr[]
