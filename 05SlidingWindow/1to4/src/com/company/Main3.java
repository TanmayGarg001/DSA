...
public class Main3 {
    ...
    public static void main(String[] args) {
        ...
        search2BetterWay("forxxorfxdofr", "for");
    }
    ...
    private static void search2BetterWay(String txt, String pat) {//https://leetcode.com/problems/find-all-anagrams-in-a-string/
