...
//        recursionInfinite();
        ...
        System.out.println(powerFast(4, 3) + " ,steps: " + stepCount2);//here time complexity O(logn). Also, integer overflow ignore that for now.
        System.out.println(nCrossMGrid(4, 5));
    }
    ...
    public static int sum(int n) {
        ...
        //base case(the simplest possible input for this function)
        if (n == 0) {
            return 0;
        }
        if (n == 1) {
